...
function Contests({ contests, range }) {
  const contentDescription =
    "Discover upcoming coding contests on CodeVault and stay in the loop with the latest challenges. Join us, take part, and put your coding skills to the test!".toLowerCase();
    ...
    <>
      ...
      <div className="allContests scroll-smooth">
        <p className="mx-auto text-center mt-4 text-xl">
              Want challenges from more platforms?{" "} Join our <a href="https://CodeVault.com/discord" target="_blank" rel="noopener noreferrer" className="text-CodeVault-bg">Discord</a> or <button className="text-CodeVault-bg" onClick={handleClick}>
            click here
