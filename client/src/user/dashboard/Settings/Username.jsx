        ...
        <>
            <div className="flex flex-col sm:flex-row sm:space-x-20 space-y-8 sm:space-y-0 my-8">
                <div className="flex-1 mt-8">
                    <h3 className="text-base font-semibold text-gray-200">Change username</h3>
                    <p className="mt-3 font-light text-sm text-gray-500">You can change your username to another username that is not currently in use.</p>
                </div>
                ...
                <div className="flex-2 rounded-lg shadow bg-dashboardColor border border-jet">
                    <div className="p-6 sm:w-9/12">
                        ...
                        />
                        <label className="phone:l-1 mt-5 text-xs text-gray-500" htmlFor="firstName">
                            Profile:
                            <span className="text-gray-400 mx-1">CodeVault.com/u/{username}
                            </span>
                        </label>
                    </div>
                </div>
